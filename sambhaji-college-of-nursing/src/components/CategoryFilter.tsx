    ...
    <nav className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide" aria-label="Review categories">
      {categories.map((category) => (
        <button
          ...
          className={`flex-shrink-0 px-4 py-2 rounded-xl text-sm font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 ${
            selected === category
